...
@section('title')
SEWA LAPANGAN OLARAGA | LAPANGAN DETAIL
@endsection
@section('content')
                ...
                <div class="text-md flex flex-col">
                    <span class="mb-3 text-white font-semibold dark:text-gray-400">Harga Sewa : Rp {{$pemesanan->price}}</span>
                        ...
                        <div class=" flex justify-center bg-gray-200 p-2">
                            ...
                            @else
                                <span class="font-semibold text-lg text-black">Belum Bayar</span>
                            @endif
                        </div>
                </div>
            </div>
            @if ($pemesanan->status_pembayaran == 'pending')
                <div class="bg-gray-900 text-white rounded-sm mt-2 p-6 flex gap-x-2 flex-col">
                    <div class="">
                ...
                <div class="h-[2px] bg-gray-800 my-4"></div>
                        <form action="{{route('pemesanan.bayar.store', ['uuid' => $pemesanan->uuid])}}" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="flex gap-x-2 flex-col">
                                <div class="flex bg-gray-400 rounded-md p-5 flex-col text-black">
                                ...
                                <div class="flex flex-col w-full">
                                    <label for="image_pembayaran" class="font-semibold text-white text-xl mb-1">Tanggal Sewa : <span class="text-sm">Masukan Bukti Foto Pembayaran Di Sini</span></label>
